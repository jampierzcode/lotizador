                            ...
                            <li class="item gap-4">
                                <div class="details w-full">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="email" id="email" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@correo.com" required>
                                    </div>
                                </div>
                            ...
                            <li class="item gap-4">
                                <div class="details w-full">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="text" id="instagram" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingresa el link de tu perfil de Instagram" required>
                            ...
                            <li class="item gap-4">
                                <div class="details w-full">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="text" id="whatsapp" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingresa el api de conversacion api.whatsapp..." required>
                            ...
                            <li class="item gap-4">
                                <div class="details w-full">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="text" id="tiktok" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ingresa el link de tu perfil de Instagram" required>
                            ...
                            <div data-testid="scrollabel-container" class="jss791 overflow-auto w-[247px] flex flex-col rounded-b-[25px] grow items-center " style="background-color: rgb(255, 255, 255); overflow: auto;">
                                ...
                                <div class="jss805" style="background-color: rgb(255, 255, 255); flex-grow: 1;">
                                    <div data-testid="links-container" style="display: flex; justify-content: center; flex-wrap: wrap; background-color: rgb(255, 255, 255);">
                                        ...
                                        <div data-testid="not-highlighted" style="display: flex; justify-content: center; margin: 0px 9px 5px;">
