        ...
        <ul class="nav-links">
            <li class="links-menu-dashboard">
                <div class="link-block">
                    <div class="w-full">
                        <div class="menu-wrapper rounded-md flex items-center justify-between py-2 px-3 <?php echo ($currentUrl === "caja") ? ' active-link' : ''; ?> gap-4 cursor-pointer">
                        ...
                        <div class="dropdown_menu hidden px-3">
                            <a class="pl-4 w-full py-3 whitespace-nowrap text-start flex items-center text-xs" href=" ../caja">

                                <ion-icon class="w-[40px]" name="briefcase"></ion-icon>
                                <p class="w-full text-xs">Abrir Caja</p>
                            </a>
                            <a class="pl-4 w-full py-3 whitespace-nowrap text-start flex items-center text-xs <?php echo ($currentUrl === "gastos") ? ' active-link' : ''; ?>""  href=" ../gastos">
                                <ion-icon class="w-[40px]" name="cash"></ion-icon>
            ...
            <li class="links-menu-dashboard">
                <div class="link-block">
                    <div class="left-link">
                        <a class="toggle-drop <?php echo ($currentUrl === "crm" || $currentUrl === "clientes") ? ' active-link' : ''; ?>" href="../crm">
