    ...
    columns: [
      ...
      },
      {
        ...
        render: function (data, type, row) {
          ...
          <button target="_blank" keyProyect="https://lotizador.vivelainmobiliaria.pe/views/Lotizador/Clientes/?proyect=${data.id}" id="rutaEnlace" class="btnLotes"> Copiar Link </button>
